package bigsong.app.zhihu.view;
...
/**
 * Created by Jesse on 2015/11/19.
 */
public class Kanner extends FrameLayout implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        for (int i = 0; i <= len + 1; i++) {
            ...
            TextView tv_title = (TextView) fm.findViewById(R.id.iv_title);
            iv.setScaleType(ImageView.ScaleType.CENTER);
//            iv.setBackgroundResource(R.id.loading);
            if (i == 0) {
    ...
    public void onClick(View v) {
        if (mItemClickListener != null) {
            Latest.TopStoriesEntity entity = topStoriesEntities.get(vp.getCurrentItem());
